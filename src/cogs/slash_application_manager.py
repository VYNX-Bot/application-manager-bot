...
class SlashApplicationManager(ApplicationCog):
    ...
    @slash.slash_command()
    @slash.describe(
        app_id="Application ID", reason="Reason why you accept this application."
    )
    async def accept(
        self, ctx: slash.Context, app_id: str, *, reason: str = "No reason provided"
    ):
        """
    ...
    @slash.slash_command()
    @slash.describe(
        app_id="Application ID", reason="A reason why you decline this application."
    )
    async def decline(
        self, ctx: slash.Context, app_id: str, *, reason: str = "No reason provided"
    ):
