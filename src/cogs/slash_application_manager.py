import discord
from src.cogs.datas import slash_utils
import json
import aiofiles
import random
import string
...
class SApplicationManager(slash_utils.ApplicationCog):
    ...
    @slash_utils.describe(apply_="Apply to application.")
    ...
    @slash_utils.describe(app_id="Application ID")
    ...
    @slash_utils.slash_command()
    @slash_utils.describe(app_id="Application ID",reason="Reason why decline")
...
def setup(bot):
    bot.add_cog(SApplicationManager(bot))